...
function Add({ todo, setTodo }) {
  ...
  return (
    <div>
      <div className="max-w-md w-full bg-black/30 rounded-3xl shadow-2xl p-9 mb-[160px] ml-[635px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="max-w-sm mx-auto">
            <label className="block font-medium mb-2 text-gray-500">Status</label>
            <input
              type="text"
              name="todoStatus"
