...
function Pay({ onClose }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert(`Ashu you have successfully paid ${amount} to account no ${toAccount}`);
    // i will Add my transfer logic here if needed
  };

  return (
    <div>
      <div className="bg-white p-6 rounded-3xl shadow-md w-[500px] h-[500px] border rounded-3xl ml-[500px]">
        <h2 className="text-2xl font-bold text-center text-black mb-2"></h2>
