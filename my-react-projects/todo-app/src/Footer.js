function Footer() {
  return (
    <footer className="fixed bottom-0 left-0 w-full  bg-white/10 backdrop-blur-md text-gray-800 py-4 shadow-inner">
      <div className="px-4 flex flex-col md:flex-row items-center justify-between space-y-2 md:space-y-0">
        ...
        <p className="text-white">IT 2nd Year | Roll No 28241277</p>
